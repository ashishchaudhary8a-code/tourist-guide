document.getElementById("country").addEventListener("change", function () {
    ...
    if (country === "india") {
        box.innerHTML = `
            <h3>
                <img src="images/india.png" class="flag">
                India – Emergency Services
            </h3>

            <div class="card">
                <img src="images/police.png" class="icon">
                Police
                <br><a href="tel:100">Call 100</a>
            </div>

            <div class="card">
                <img src="images/ambulance.png" class="icon">
                Ambulance
                <br><a href="tel:108">Call 108</a>
            </div>

            <div class="card">
                <img src="images/fire.png" class="icon">
                Fire Brigade
                <br><a href="tel:101">Call 101</a>
            </div>

            <div class="card">
                <img src="images/women.png" class="icon">
                Women Safety
                <br><a href="tel:181">Call 181</a>
            </div>

            <div class="card">
                <img src="images/child.png" class="icon">
                Child Helpline
                <br><a href="tel:1098">Call 1098</a>
            </div>

            <div class="card">
                <img src="images/disaster.png" class="icon">
                Disaster / Emergency
                <br><a href="tel:112">Call 112</a>
            </div>

            <div class="card">
                <img src="images/tourist.png" class="icon">
                Tourist Helpline
                <br><a href="tel:1363">Call 1363</a>
            </div>

            <div class="card">
                <img src="images/senior.png" class="icon">
